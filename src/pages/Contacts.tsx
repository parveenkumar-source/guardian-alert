...
import { getContacts, addContact, removeContact, EmergencyContact } from "@/lib/contacts";
...
const ContactsPage = () => {
  ...
  const handleAdd = () => {
    ...
    const contact = addContact({ name: name.trim(), phone: phone.trim(), relationship: relationship.trim() || "Other" });
