...
const Index = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      description: "Alert family and friends instantly with one tap",
    },
    {
      icon: Bell,
    ...
    },
    {
      ...
      description: "End-to-end encrypted data, your privacy matters",
    },
  ];
  ...
  return (
    <div className="min-h-screen pt-16">
      {sosState === "activating" && (
        <SOSActivation onCancel={handleSOSCancel} onConfirm={handleSOSConfirm} />
      )}
      {sosState === "confirmed" && (
        <SOSConfirmed
          location={location}
      ...
      <section className="relative min-h-[calc(100vh-4rem)] flex flex-col items-center justify-center px-4 overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center gap-8 max-w-lg w-full opacity-0 animate-fade-in-up" style={{ animationFillMode: "forwards" }}>
          ...
          <div className="flex gap-3 w-full max-w-xs">
            <Link
              to="/contacts"
              className="flex-1 glass-card-hover p-3 flex flex-col items-center gap-1.5 text-center"
            >
        ...
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {features.map((feature, i) => (
              <div
                key={feature.title}
                className="glass-card-hover p-6 flex items-start gap-4 opacity-0 animate-fade-in-up"
